...
class SrtSocket(private val host: String, private val port: Int) {
  ...
  // TAKPILOT2 CHANGE: was Constants.MTU, which now sizes the SEND path and is smaller than
  // what the server may send us. See Constants.READ_BUFFER.
  private var packetSize = Constants.READ_BUFFER
