...
open class CommandsManager {
  ...
  private fun addHeaders(): String {
    return "CSeq: ${++cSeq}\r\n" +
        // Vendored from com.pedro.rtsp (see NOTICE.txt) — originally read the library
        // module's own generated BuildConfig; that module no longer exists in this tree,
        // so a static identifier replaces it. Purely an RTSP header string, no behavior.
        "User-Agent: TAKPilot2-Go RTSP\r\n" +
